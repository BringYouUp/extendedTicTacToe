...
export { START_GAME, SIZE_OF_BOARD, WIN_STREAK, HALF_OF_WIN_STREAK, IMG_NEW_GAME, IMG_BOT, IMG_BOT_ACTIVE, IMG_BOT_FIRST, IMG_BOT_NOT_FIRST, IMG_HISTORY, IMG_HELP, IMG_TIC, IMG_TAC }